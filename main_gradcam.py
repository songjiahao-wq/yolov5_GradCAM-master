...
parser.add_argument('--img-path', type=str, default=r'testt/test2', help='input image path')
parser.add_argument('--output-dir', type=str, default='2outputs20_s/', help='output dir')
parser.add_argument('--img-size', type=int, default=640, help="input image size")
parser.add_argument('--target-layer', type=str, default='model_20_cv3_act',
                    help='The layer hierarchical address to which gradcam will applied,'
                         ' the names should be separated by underline')
parser.add_argument('--method', type=str, default='gradcam', help='gradcam method')
parser.add_argument('--device', type=str, default='cuda', help='cuda or cpu')
parser.add_argument('--no_text_box', default=False,action='store_true',
...
def main(img_path):
    ...
    for target_layer in target_layers:
        ...
        output_path = f'{save_path}/{target_layer[6:8]}_{i}.jpg'
            # output_path = f'{save_path}/{target_layer[6:8]}.jpg'
